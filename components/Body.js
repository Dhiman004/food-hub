...
// import food_video from '../assets/food_video.mp4';
...
const Body = () => {
  useEffect(() => {
    ...
    productContainers.forEach((item, i) => {
      ...
      let containerWidth = containerDimensions.width; // Define containerWidth here
